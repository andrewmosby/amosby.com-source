	...
	<div class="padding">
		<div class="column-small column-centered">
			...
			<div v-if="view === 'list'" class="printHide">
				<p>As you can see, this is the <strong>traditional format</strong> of my résumé. But ingrained in every résumé are life experiences that mold us and shape us. If we take the time, our dry bulleted lists can be connected to form a vibrant picture of who we are today.</p>
			...
			<div class="contentEntry printHide">
				<p>Now that you've seen my résumé, feel free to <a @click="changePage('projects')">see some of my work</a>, read about my <a @click="changePage('philosophies')">front end values</a>, or get to know me <a @click="changePage('about')">just a little more personally</a>.</p>
			</div>
		</div>
	</div>
</template>
